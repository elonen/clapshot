...
const translations = {
    ...
    fr: {
        ...
        'status.collabSessionId': 'ID de session : {id}',
        'status.collabActionsMirrored': 'Les actions comme la navigation, la lecture et le dessin sont synchronisées pour tous les participants.',
        ...
        'nav.importEdl': 'Importer EDL en commentaires',
        ...
        'comments.placeholderTimed': 'Ajouter un commentaire au temps actuel...',
        'comments.placeholderUntimed': 'Ajouter un commentaire...',
        'comments.timedToggleTitle': 'Le commentaire est lié à un instant précis ?',
