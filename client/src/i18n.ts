...
const translations = {
    ...
    fr: {
        ...
        'status.viewConnectionErrors': 'Voir les erreurs de connexion',
        'status.latestMessages': 'Derniers messages',
        'status.collabActiveTitle': 'Session de visionnage collaboratif active.',
        'status.collabSessionId': 'Identifiant de session : {id}',
        'status.collabActionsMirrored': 'Les actions comme le déplacement, la lecture et le dessin sont synchronisées avec tous les participants.',
        'status.collabInvite': 'Pour inviter des personnes, copiez l\'URL du navigateur et envoyez-la leur.',
        'status.collabExit': 'Quitter en cliquant sur l\'icône verte dans l\'en-tête.',
        'status.collabUnderstood': 'Compris',
        'status.reloadToLogin': 'Rechargez la page pour vous reconnecter.',
        'status.subtitles': 'Sous-titres',
        'status.dropInstruction': 'Déposez des fichiers vidéo, audio et image ici pour les téléverser',

        'nav.shareToLoggedInUsers': 'Partager avec les utilisateurs connectés',
        'nav.downloadOriginal': 'Télécharger l\'original',
        'nav.leaveCollab': 'Quitter la session collaborative',
        'nav.startCollab': 'Démarrer une session collaborative',
        'nav.experimentalTools': 'Outils expérimentaux',
        'nav.importEdl': 'Importer EDL comme commentaires',
        'nav.exportComments': 'Exporter les commentaires',
        'nav.about': 'À propos',
        'nav.logout': 'Déconnexion',
        'nav.language': 'Langue',

        'upload.uploading': 'Téléversement : {filename}...',
        'upload.progress': '{percent}% téléversé... veuillez patienter',
        'upload.failed': 'Échec du téléversement',
        'upload.aborted': 'Téléversement annulé',
        'upload.rejected': 'Fichier refusé. Seuls les fichiers vidéo, audio et image sont acceptés.',
        'upload.complete': 'Téléversement terminé',

        'comments.placeholderTimed': 'Ajouter un commentaire — au moment actuel...',
        'comments.placeholderUntimed': 'Ajouter un commentaire...',
        'comments.timedToggleTitle': 'Commentaire lié à un instant précis ?',
        'comments.drawOnVideo': 'Dessiner sur la vidéo',
        'comments.send': 'Envoyer',
        'comments.undo': 'Annuler',
        'comments.redo': 'Rétablir',
        'comments.deleteConfirm': 'Supprimer le commentaire ?',
        'comments.copyLink': 'Copier le lien',
        'comments.linkCopied': 'Lien copié dans le presse-papiers',
        'comments.reply': 'Répondre',
        'comments.edit': 'Modifier',
        'comments.deleteShort': 'Suppr.',
        'comments.yourReply': 'Votre réponse...',
        'comments.editedSuffix': '(modifié)',
        'comments.sortByTimecode': 'Tri : timecode',
        'comments.sortByDate': 'Tri : date de publication',

        'subtitles.edit': 'Modifier le sous-titre',
        'subtitles.label': 'Titre',
        'subtitles.languageCode': 'Code de langue',
        'subtitles.timeOffset': 'Décalage temporel (sec)',
        'subtitles.defaultSubtitle': 'Sous-titre par défaut',
        'subtitles.save': 'Enregistrer',
        'subtitles.download': 'Télécharger',
        'subtitles.delete': 'Suppr.',
        ...
        'nav.exportComments': 'Vie kommentit',
        'nav.about': 'Tietoja',
