...
<div 
  transition:scale
  class="block rounded-lg shadow-lg bg-gray-800" style="margin-left: {indent*1.5}em"
  ...
  <div class="block flex mx-2 pt-1">
    ...
    <span 
      on:click="{(e) => { onTimecodeClick(e.target.innerText) }}"
  ...
  {#if show_actions}
  <div class="p-2 flex place-content-end" transition:slide>
