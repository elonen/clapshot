...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  ...
  <a href="/" class="flex items-center">
      <img src="src/assets/svelte.svg" class="mr-3 h-6 sm:h-9" alt="Svelte">
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PAUSEFUL media reviewer</span>
  </a>
